...
# Функция bfs_iterativeинициализирует множество visitedдля хранения посещенных вершин и dequeдля хранения очереди посещаемых вершин. 
# В цикле whileалгоритм продолжает изымать вершины из очереди, печатать их, 
# добавлять их в множество посещенных вершин и добавлять их непосещенных соседей в конец очереди, пока очередь не станет пустой.