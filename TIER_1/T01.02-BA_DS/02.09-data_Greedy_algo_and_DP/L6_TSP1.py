# Задача коммивояжера ( TSP – Traveling Salesman Problem ) – это классическая задача оптимизации, 
# которая заключается в нахождении кратчайшего возможного маршрута, по которому можно посетить каждый город 
# только один раз и вернуться в начальный город. Это NP – полная задача, означающая, что время нахождения 
# точного решения растет экспоненциально с увеличением количества городов.
